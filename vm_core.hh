...
VM_ENV_PREV_EP(const VALUE *ep)
{
    ...
    return reinterpret_cast<VALUE *>(GC_GUARDED_PTR_REF(ep[VM_ENV_DATA_INDEX_SPECVAL]));
}
...
{
    struct rb_captured_block *captured = reinterpret_cast<struct rb_captured_block *>(VM_TAGGED_PTR_REF(block_handler, 0x03));
    VM_ASSERT(VM_BH_ISEQ_BLOCK_P(block_handler));
    return captured;
}
