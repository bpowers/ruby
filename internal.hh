...
{
    MAYBE_UNUSED(struct RVALUE *) ptr = reinterpret_cast<struct RVALUE *>(obj);
...
{
    return static_cast<enum imemo_type>((RBASIC(imemo)->flags >> FL_USHIFT) & IMEMO_MASK);
}
...
{
    ((rb_imemo_tmpbuf_t *)v)->ptr = reinterpret_cast<VALUE *>(ptr);
...
rb_imemo_tmpbuf_auto_free_pointer_new_from_an_RString(VALUE str)
{
    ...
    memcpy(dst, src, len);
    tmpbuf->ptr = reinterpret_cast<VALUE *>(dst);
    return imemo;
}
